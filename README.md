...
Then do: python train.py --config path_to_config
...
```
cd existing_repo
git remote add origin https://gitlab.inf.ethz.ch/OU-JBUHMANN/digipath/causal-invariance-in-ad.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.inf.ethz.ch/OU-JBUHMANN/digipath/causal-invariance-in-ad/-/settings/integrations)
